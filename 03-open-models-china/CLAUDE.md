# The Open Model Playbook

You are writing a single technical article for the Ligency publication. Read this file completely before writing anything. Then read the research in `research/` (start with `research/open-model-playbook-synthesis.md`) and the brief in `references/article-brief.md` before drafting.
 
---
 
## The angle
 
This is an analytical deep-dive, not a news recap. The reader should finish feeling like they sat with someone who read past the headlines and actually checked the numbers. Every claim about who's ahead, who's cheap, who's winning adoption gets backed by something verifiable: a benchmark score, a price per million tokens, a download share, a release date, a named source. The reflex take is "China caught up with the US." Don't repeat that. The argument here is sharper: Chinese labs turned open weights into a distribution strategy, and the capability gap is real but narrow and roughly steady.

Treat vendor benchmarks as marketing until an independent source confirms them. A lot of the mid-2026 story is labs grading their own homework, and the research already caught four claims that fall apart on inspection (see the synthesis). Half the value of this piece is telling the reader which numbers to trust.
 
If a claim can't be tied to a number, a source, or a date, it probably belongs in a different article. And keep the DeepSeek-origin story short, the brief is explicit: that's the spark, not the subject. The subject is now.
 
## The reader
 
One person: a technically literate reader who follows AI closely but doesn't build models for a living. A developer, a founder, an engineering manager, someone deciding whether to put an open model into a product or just trying to understand the landscape past the press cycle. They can read a benchmark table. They have not memorized which lab shipped what this quarter. Write for the person weighing "should I actually use one of these, and which."
 
They've seen the DeepSeek headlines and the "China is winning" takes. They want the honest version: what open weights actually buy you, what they cost you, and which of the dozen Chinese labs matters for what. Define the load-bearing terms when they first appear, open-weight vs open-source, distillation, mixture-of-experts, a short parenthetical is usually enough. Don't assume they know the difference between an Intelligence Index of 54 and 60 until you've told them. Do that work for them.
...
**Every paragraph either lands a number or advances the argument.** No paragraph exists to restate, transition, or warm up. If a paragraph carries no concrete figure (price, score, date, share, version) and doesn't move the section's claim forward, cut it. Don't be verbose for its own sake. Concise beats complete.

**Keep sentences plain and concrete. Simplify on sight.** When a sentence stacks three or four ideas behind commas and subordinate clauses, break it into shorter ones. State the concrete thing instead of gesturing at it abstractly: "the next round of competition is moving toward agents, coding, and robots" beats "where all of this is heading is away from the chatbot." Swap jargon and abstraction for plain words: "is strategy" not "reads as deliberate industrial policy," "hands the model to the whole world" not "turns the entire outside world into its feedback loop." Vague framing openers ("Where all of this is heading is...", "The thing to understand here is...") are a smell, lead with the actual point. If a reader has to re-read a sentence to parse it, it's too dense. Take the shorter, plainer version every time, even at the cost of a little elegance.
